...
#   node-red-admin install node-red-contrib-uibuilder
  ...
  node-red-admin install @flowfuse/node-red-dashboard
  node-red-admin install node-red-contrib-date-converter
  node-red-admin install node-red-contrib-mqtt-broker
  node-red-admin install node-red-contrib-time-switch
  node-red-admin install node-red-contrib-toggle
  node-red-admin install node-red-contrib-web-worldmap
  node-red-admin install node-red-node-random
  node-red-admin install node-red-node-serialport
  node-red-admin install
  node-red-admin install
  node-red-admin install
